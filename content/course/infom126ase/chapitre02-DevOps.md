...
- Retail : expérience mobile, recommandations à l’achat, passage en caisse fluide. La logistique et le SI s’alignent sur des microservices pour croître ville par ville. Pointeur : [Blog de PicNic](https://jobs.picnic.app/en/blogs/).
...
![DevOps infinite loop](devops.png "Boucle DevOps")

### Origine et intention

Le terme *DevOps* émerge autour de 2009 dans la communauté [DevOpsDays](https://devopsdays.org/). Le problème à résoudre est le suivant : *Concevoir des systèmes distribués, sécurisés, résilients, évolutifs, et les faire évoluer rapidement à l’échelle*. Il s'accompagne de deux constats :

1. Si nous supposons que **les estimations de la maturité ou des capacités faites par les praticiens sont plus exactes** (parce qu’ils sont plus proches du travail), alors le potentiel de création de valeur et de croissance au sein des organisations est bien plus important que ce que les dirigeants perçoivent actuellement.
2. Ce décalage met clairement en évidence la nécessité de mesurer avec précision les capacités de l'organisation et de **communiquer ces résultats de mesure aux dirigeants** afin qu'iels puissent les utiliser pour **prendre des décisions et définir la stratégie** concernant la posture technologique de leur organisation.

### Vision d’ensemble

DevOps relie Développement (Dev) et Opérations (Ops) dans un cycle continu : ce qui est observé en production (monitoring, incidents, usage) nourrit les décisions de conception et de priorisation côté développement. Inversement, les changements construits côté Dev sont mis en production de manière automatisée, sûre et reproductible.

Les approches DevOps visent deux objectifs. Premièrement, **réduire le « mur de la confusion » entre devs et ops** en alignant objectifs et indicateurs. Ce mur est difficile à faire tomber de par la nature des activités et des objectifs individuels des développeurs, qui visent le changement et la mise à jour rapide d'application pour coller aux besoins des utilisateurs, et des opérateur, qui visent avant tout la stabilité et la sécurité du système.

![Wall of confusion](wall-of-confusion.jpg "Mur de la confusion entre développeurs et opérateurs ([source](https://www.linkedin.com/pulse/remove-walls-confusion-rethink-devops-unlock-its-full-glenn-mason/))")

Deuxièmement, **mesurer des résultats généraux (*outcomes*) plutôt que l’« output » individuel**. Le but est de faciliter la communication et d'éviter les silos entre rôles ou départements au sein d'un même organisation.
